...
france({ nomCom: "developer", categorie: "General", reaction: "🐐" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Blvck Castro", numero: "254758682666" },
      { nom: "᚛Blvckcastro᚜", numero: "254758682666" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 *Welcome to Ghost-Md!* here is the developer numbers:\n\n";
...
france({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `https://wa.me/254758682666`},{quoted :ms})
